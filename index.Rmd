...
### The example - *Efficient Vector/Raster handling*
...
- Perform simple data.frame manipulation
...
The basic scripting skills required when wanting to automate things are:
...
Much more advanced examples are possible, as shown below, with an integration of shiny and [leaflet](http://leafletjs.com/).
...
Submit a 1 page document where you identify the potential contribution of Geo-scripting for yourself, as well as the specific R or python knowledge you would need to learn about. Keep it short, to the point and structured.
