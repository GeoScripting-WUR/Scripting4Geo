...
Submit a (maximum) 1 page document where you identify per team:
...
Keep it short, to the point and structured (e.g. a list of items are ok, no full sentences are needed). The deadline is before the end of today (6/01).
