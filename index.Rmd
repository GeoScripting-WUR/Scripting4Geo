...
output:
  knitrBootstrap::bootstrap_document:
    title: "Week 1, Lesson 2: Scripting for Geo-Information Sciences, demonstration of capabilities"
    theme: cosmo
    menu: FALSE
---
...
Time  | Activity
------------- | -------------
Morning  |  Self-study: go through the demo's below and finalise yesterdays lesson
1330 to 1530  | Presentation by Fritz van Deventer (https://www.nelen-schuurmans.nl/) and Allard de Wit (Alterra) about Linux, Introduction to OSGEO-live!
...
Then create the graph using `gvisScatterChart`:
